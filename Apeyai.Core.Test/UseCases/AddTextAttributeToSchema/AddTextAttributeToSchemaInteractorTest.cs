...
namespace Apeyai.Core.Test.UseCases.AddTextAttributeToSchema
{
    public class AddTextAttributeToSchemaInteractorTest
    {
        ...
        {
            _schemaRepositoryMock.Setup(repo => repo.AddTextAttributeToSchema(It.IsAny<int>(), It.IsAny<TextAttribute>())).Returns(Task.FromResult(9));

            var createTextAttributeRequest = new AddTextAttributeToSchemaRequest() { SchemaId = 12, MinLength = 1, Maxlength = 15, IsRequired = true, AttributeName = "UserId"};
        ...
        {
            _schemaRepositoryMock.Setup(repo => repo.AddTextAttributeToSchema(It.IsAny<int>(), It.IsAny<TextAttribute>())).Throws<EntityAlreadyExistsException>();
            ...
            response.AttributeId.Should().BeNull();
        ...
        {
            _schemaRepositoryMock.Setup(repo => repo.AddTextAttributeToSchema(It.IsAny<int>(), It.IsAny<TextAttribute>())).Throws<RepositoryException>();
        ...
        {
            var createTextAttributeRequest = new AddTextAttributeToSchemaRequest() { SchemaId = 12, MinLength = 20, Maxlength = 15, IsRequired = true, AttributeName = "UserId" };
            var interactor = new AddTextAttributeToSchemaInteractor(createTextAttributeRequest, _schemaRepositoryMock.Object, _createTextAttributePresenterMock.Object);
